## IdleState — grounded, no horizontal input.
extends PlayerState
...
func physics_update(delta: float) -> String:
	# Leaving the ground (walked off a ledge) hands off to Fall; coyote time in
	# the Player keeps a jump available for a few frames afterward.
